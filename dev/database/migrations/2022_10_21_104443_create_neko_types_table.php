...
class CreateNekoTypesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('neko_types', function (Blueprint $table) {
            $table->integer('id', true);
            $table->string('neko_type_name')->nullable()->comment('ネコ種別');
    ...
    {
        Schema::dropIfExists('neko_types');
    }
}
